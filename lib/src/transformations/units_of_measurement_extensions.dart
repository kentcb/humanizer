...
extension AreaRateExtensions on AreaRate {
...
extension InformationSizeExtensions on InformationSize {
  /// Humanizes this [InformationSize] using the specified [pattern], which is forwarded to an
...
extension InformationRateExtensions on InformationRate {
  /// Humanizes this [InformationRate] using the specified [pattern], which is forwarded to an
...
extension LengthExtensions on Length {
...
extension LengthRateExtensions on LengthRate {
...
extension TemperatureRateExtensions on TemperatureRate {
  /// Humanizes this [TemperatureRate] using the specified [pattern], which is forwarded to a
...
extension TimeRateExtensions on TimeRate {
...
extension VolumeRateExtensions on VolumeRate {
...
extension WeightRateExtensions on WeightRate {

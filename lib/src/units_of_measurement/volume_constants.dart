...
final cubicMetersInImperialTeaspoon = cubicMetersInImperialTablespoon * Rationals.third;
final cubicMetersInImperialTablespoon = cubicMetersInImperialCup * Rational.fromInt(1, 16);
final cubicMetersInImperialFluidOunce = cubicMetersInImperialCup * Rationals.tenth;
...
final cubicMetersInImperialQuart = cubicMetersInImperialGallon * Rationals.quarter;
...
final cubicMetersInUsFluidOunce = cubicMetersInUsCustomaryCup * Rationals.eighth;
...
final cubicMetersInUsLiquidQuart = cubicMetersInUsLiquidGallon * Rationals.quarter;
final cubicMetersInUsLiquidGallon = metersInInch * metersInInch * metersInInch * Rational.fromInt(231);
